...
const AREAS_DE_EDICAO = ['injetora', 'paradas', 'qualidade'];
...
const PERFIS = {
  ...
  Encarregado: {
    rotulo: 'Encarregado',
    editar: ['injetora', 'qualidade', 'paradas'],
  },
  // Setor de Manutenção (chamados, programada) foi descontinuado — este
  // perfil continua existindo (não apaga usuários já cadastrados com
  // ele), mas só edita Paradas agora, igual antes tinha 'manutencao'
  // também.
  Manutencao: {
    rotulo: 'Manutenção',
    editar: ['paradas'],
...
const PAGINAS_DE_TRABALHO = [
  ...
  // logo acima ("TODAS são visíveis a TODOS os perfis") e as 2 já
...
// domínio (paradas, qualidade, injetora/edição de histórico).
