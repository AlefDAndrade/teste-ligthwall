...
const CATALOGO = [
  ...
  // Peças (Compra) e Almoxarifado já existem como abas de Manutenção hoje
  // (page-manutencao.html) mas não foram citadas na última lista — inclusas
  // aqui pra não deixar um buraco no catálogo; ajustável junto com o resto
  // de Manutenção quando vier a próxima rodada de mudanças.
  { id: 'manutencao-pecas', rotulo: 'Peças (Compra)', tipo: 'sub', pai: 'manutencao', area: 'manutencao' },
  { id: 'manutencao-almoxarifado', rotulo: 'Almoxarifado', tipo: 'sub', pai: 'manutencao', area: 'manutencao' },
...
module.exports = { CATALOGO, NIVEIS, ITENS_POR_AREA, itemValido };
