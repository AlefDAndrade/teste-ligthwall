...
//
// Domínio mais simples que Operadores: nenhuma rota aqui exige senha/sessão
// (paradas sempre foram de escrita livre, como o resto do registro
// operacional — ver README) — a única dependência real é `db`.

module.exports = function criarRotasParadas({ db }) {
