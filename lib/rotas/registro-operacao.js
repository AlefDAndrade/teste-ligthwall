          ...
          db.transaction(() => {
            dadosRecebidos.forEach(novoTraco => {
              ...
              if (!tracoExiste) {
                ...
                // Insumos CUSTOM (Fase 3, ver PLANO-insumos-dinamicos-receitas.md)
                // — só grava no traço NOVO (mesma regra dos 5 Padrão acima:
                // nunca reescreve a receita de um traço reaproveitado).
