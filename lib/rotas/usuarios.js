...
module.exports = function criarRotasUsuarios({ fs, path, PRIVATE_DIR, auth, sessao, sessaoUsuario, perfis, perfisCustomizados }) {
  ...
  function perfisComControleDeOperacaoMesclados() {
    const fixos = [...perfis.PERFIS_COM_CONTROLE_DE_OPERACAO];
