  ...
  function detalheOperacao(idOperacao) {
    ...
    const tracos = usos.map(u => {
      ...
      return {
        ...
        // Só entra a chave se o traço de fato tiver algum Custom — não
        // polui a saída de quem nunca usou a feature (mesmo critério de
        // montarInsumosCustom, lib/db/tracos.js).
        ...(Object.keys(insumosCustomOriginais).length ? { insumos_custom: insumosCustomOriginais } : {}),
