...
module.exports = function criarDbTracos(db) {
  ...
  //  (ver README, "Insumos de Receitas dinâmicos — plano").
  //
  ...
  //  (ficam como legado só pra esta migração poder rodar; nenhum código
  //  novo deve lê-las/escrevê-las depois da Fase 2, quando
  //  rowParaTraco/SQL_INSERIR_TRACO/SQL_INSERIR_AJUSTE forem
  //  reescritos pra usar só as tabelas dinâmicas).
  // ============================================================
