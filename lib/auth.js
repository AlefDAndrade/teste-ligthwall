...
module.exports = function criarAuth(SECURITY_PATH) {
  ...
  function criarSecurityInicial() {
    ...
    console.log('\n' + '='.repeat(72));
    console.log('security.json não existia — 1ª execução deste servidor.');
    console.log('Senha inicial do Administrador (só aparece agora, anote):');
    console.log('  ' + senhaInicial);
    console.log('Troque assim que possível (Configurações → Segurança do Administrador).');
