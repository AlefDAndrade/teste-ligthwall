...
// podeControlarOperacao() (lib/permissoes-area.js) — usada por
// POST /registrar-operacao, POST /registrar-relatorio-injecao,
// POST /salvar-operacao-andamento, POST /marcar-berco-andamento,
// POST /confirmar-tracos-hoje.
//
...
//     'injetora' de edição (OperadorInjetora, Encarregado, Supervisao —
//     ver PERFIS_COM_CONTROLE_DE_OPERACAO) E podeIniciarOperacao:true no
//     cadastro.
...
// computadores em Configurações → Dispositivos Autorizados, testada nesta
// mesma suíte) foi removida — abandonada em favor de manter só a lógica
// de perfis autorizados (ver histórico do git se precisar resgatar
// lib/dispositivo-autorizado.js/lib/dispositivo-cookie.js/
// lib/rotas/dispositivos-autorizados.js).
